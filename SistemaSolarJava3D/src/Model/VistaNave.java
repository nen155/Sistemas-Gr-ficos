...
public class VistaNave extends Vista {

    public VistaNave(Canvas3D canvas) {
        super(canvas);
        ...
        viewTransform3D.lookAt (new Point3d (0,50,50), new Point3d (0,50,1000), new Vector3d (0,1,0));
